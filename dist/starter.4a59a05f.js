...
//   module.hot.accept();
// }
const controleRecipes = async function(id) {
    try {
...
const controleServings = function(newServings) {
    ...
    _modelJs.uptadeServings(newServings);
    // Update recipe view
...
const init = function() {
    ...
    // Za direktan URL ili promenu preko back/forward
    (0, _recipeViewJsDefault.default).addHandlerRender(controleRecipes);
    (0, _recipeViewJsDefault.default).addHandlerUpdateSevings(controleServings);
    (0, _recipeViewJsDefault.default).addHandlerAddBookmark(controlAddBookmark);
    // Za pretragu i klikove na rezultate
...
parcelHelpers.export(exports, "uptadeServings", ()=>uptadeServings);
...
const loadSearchResults = async function(query) {
    try {
        ...
        // Resetuj stranicu na 1 za novu pretragu
        });
        state.search.page = 1;
    } catch (err) {
        console.error(`${err} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`);
...
const uptadeServings = function(newServings) {
...
const deleteBookmark = function(id) {
    // 1. Pronađi index bookmarka (OVO JE NEOPHODNO)
    const index = state.bookmarks.findIndex((el)=>el.id === id);
    // 2. Proveri da li bookmark postoji
    if (index === -1) return; // Prekini ako ne postoji
    // 3. Ukloni bookmark iz niza (OVO JE KLIJUČNI DEO KOJI FALI)
    state.bookmarks.splice(index, 1);
    // 4. Ažuriraj status trenutnog recepta
...
const KEY = 'cd840096-6191-4a85-9988-9827c4916476';
...
class View {
   ...
   */ render(data, render = true) {
        if (!data || Object.keys(data).length === 0) // Proverava prazan objekat
...
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class AddRecipeViev extends (0, _viewJsDefault.default) {
...
exports.default = new AddRecipeViev();
